        ...
        if ("date".equals(fieldName)) {
            ...
            if (jsonParser.getCurrentToken() == JsonToken.START_ARRAY) {
                ...
                while (jsonParser.nextToken() != JsonToken.END_ARRAY) {
                    Object value1;
                    value1 = IO_LOGANSQUAREX_CORE_OBJECTMAPPERS_OBJECTMAPPER.parse(jsonParser);
            ...
            if (jsonParser.getCurrentToken() == JsonToken.START_OBJECT) {
                ...
                while (jsonParser.nextToken() != JsonToken.END_OBJECT) {
                    ...
                    if (jsonParser.getCurrentToken() == JsonToken.VALUE_NULL) {
                        ...
                        map1.put(key1, IO_LOGANSQUAREX_CORE_OBJECTMAPPERS_OBJECTMAPPER.parse(jsonParser));
                    }
                }
    ...
    public void serialize(SimpleModel object, JsonGenerator jsonGenerator, boolean writeStartAndEnd) throws IOException {
        ...
        if (lslocalobject_array_with_dashes != null) {
            ...
            for (Object element1 : lslocalobject_array_with_dashes) {
                if (element1 != null) {
                    IO_LOGANSQUAREX_CORE_OBJECTMAPPERS_OBJECTMAPPER.serialize(element1, jsonGenerator, false);
                }
            }
        ...
        if (lslocalobject_map != null) {
            ...
            for (Map.Entry<String, Object> entry1 : lslocalobject_map.entrySet()) {
                ...
                if (entry1.getValue() != null) {
                    IO_LOGANSQUAREX_CORE_OBJECTMAPPERS_OBJECTMAPPER.serialize(entry1.getValue(), jsonGenerator, false);
                }
            }

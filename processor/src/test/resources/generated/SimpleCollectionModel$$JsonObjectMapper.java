        ...
        if ("model_array".equals(fieldName)) {
            if (jsonParser.getCurrentToken() == JsonToken.START_ARRAY) {
                ...
                while (jsonParser.nextToken() != JsonToken.END_ARRAY) {
                    ...
                    value1 = IO_LOGANSQUAREX_PROCESSOR_SIMPLECOLLECTIONMODEL_MODELFORCOLLECTION__JSONOBJECTMAPPER.parse(jsonParser);
            ...
            if (jsonParser.getCurrentToken() == JsonToken.START_OBJECT) {
                ...
                while (jsonParser.nextToken() != JsonToken.END_OBJECT) {
                    ...
                    if (jsonParser.getCurrentToken() == JsonToken.VALUE_NULL) {
                        ...
                        map1.put(key1, IO_LOGANSQUAREX_PROCESSOR_SIMPLECOLLECTIONMODEL_MODELFORCOLLECTION__JSONOBJECTMAPPER.parse(jsonParser));
                    }
                }
    ...
    public void serialize(SimpleCollectionModel object, JsonGenerator jsonGenerator, boolean writeStartAndEnd) throws IOException {
        ...
        if (lslocalmodel_array != null) {
            ...
            for (SimpleCollectionModel.ModelForCollection element1 : lslocalmodel_array) {
                if (element1 != null) {
                    IO_LOGANSQUAREX_PROCESSOR_SIMPLECOLLECTIONMODEL_MODELFORCOLLECTION__JSONOBJECTMAPPER.serialize(element1, jsonGenerator, true);
                }
            }
        ...
        if (lslocalmodel_hash_map != null) {
            ...
            for (Map.Entry<String, SimpleCollectionModel.ModelForCollection> entry1 : lslocalmodel_hash_map.entrySet()) {
                ...
                if (entry1.getValue() != null) {
                    IO_LOGANSQUAREX_PROCESSOR_SIMPLECOLLECTIONMODEL_MODELFORCOLLECTION__JSONOBJECTMAPPER.serialize(entry1.getValue(), jsonGenerator, true);
                }
            }
